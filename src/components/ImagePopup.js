...
export default function ImagePopup (props) {
        const isOpen = props.card ?'popup_opened' :'';
        return (
            <div className={`popup popup_area_photo ${isOpen}`}>
                <form name="Photo" className="popup__content popup__content_place_photo" noValidate>
                    ...
                    <h2 className="popup__heading popup__heading_place_photo">{props.card ?props.card.name :''}</h2>
                </form>
            </div>
        )
    }